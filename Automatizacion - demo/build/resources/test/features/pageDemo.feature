  ...
  Feature: pageDemo
    ...
    Scenario Outline: Enter data to register
      ...
      When she enters the data in the form
        | firstname   | lastname   | address   | email   | phone   | gender   | year   | month   | day   | password1   | password2   |
        | <firstname> | <lastname> | <address> | <email> | <phone> | <gender> | <year> | <month> | <day> | <password1> | <password2> |
      ...
      Examples:
        | firstname | lastname | address  | email              | phone      | gender | year | month | day | password1  | password2  |
        | Tania     | Ruiz     | Av Japon | tania@hotmail.com  | 3103900118 | Male   | 1995 | April | 10  | Tania123*  | Tania123*  |
        | Patricia  | Sanchez  | Av cuba  | tania1@hotmail.com | 3103900120 | FeMale | 1966 | April | 30  | Tania1234* | Tania1234* |
