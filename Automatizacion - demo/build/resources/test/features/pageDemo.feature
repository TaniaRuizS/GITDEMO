...
Feature: pageDemo
  ...
  Scenario Outline: Enter data to register
    ...
    Examples:
      ...
      | Patricia  | Sanchez  | Av cuba   | tania1@hotmail.com | 3103900120 | FeMale | Movies-Hockey  | Malay          | C++    | Select Country | india         | 1966 | April | 30  | Tania1234* | Tania1234* | C:\Users\user\Downloads\Copia reto III EL ULTIMO QUE MANDE AL CORREO GIT\Reto Languaje - copia - copia - copia\Automatizacion - demo\src\test\resources\Imagen\ImagenPrueba.PNG | Select Country\n |
      | Dino      | Perez    | Av Dosque | dino1@hotmail.com  | 3103900121 | Male   | Hockey-Movies  | Persian        | Linux  | Select Country | Denmark       | 1966 | April | 21  | Tania1234* | Tania1234* | C:\Users\user\Downloads\Copia reto III EL ULTIMO QUE MANDE AL CORREO GIT\Reto Languaje - copia - copia - copia\Automatizacion - demo\src\test\resources\Imagen\ImagenPrueba.PNG | Select Country\n |
