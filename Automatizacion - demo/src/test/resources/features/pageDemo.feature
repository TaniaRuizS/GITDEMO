...
Feature: pageDemo
  ...
  Scenario Outline: Enter data to register
    ...
    When she enters the data in the form
      | firstname   | lastname   | address   | email   | phone   | gender   | hobbies   | languajes   | skills   | country   | selectcountry   | year   | month   | day   | password1   | password2   | file   |
      | <firstname> | <lastname> | <address> | <email> | <phone> | <gender> | <hobbies> | <languajes> | <skills> | <country> | <selectcountry> | <year> | <month> | <day> | <password1> | <password2> | <file> |
    ...
    Examples:
      | firstname | lastname | address   | email              | phone      | gender | hobbies        | languajes      | skills | country        | selectcountry | year | month | day | password1  | password2  | file                                                                                                                | selectcountryR   |
      | Tania     | Ruiz     | Av Japon  | tania@hotmail.com  | 3103900118 | Male   | Cricket-Movies | Japanese-Malay | C      | Select Country | Japan         | 1995 | April | 10  | Tania123*  | Tania123*  | C:\Users\user\Documents\GITDEMO - Register\GITDEMO\Automatizacion - demo\src\test\resources\Imagen\ImagenPrueba.PNG | Select Country\n |
      | Patricia  | Sanchez  | Av cuba   | tania1@hotmail.com | 3103900120 | FeMale | Movies-Hockey  | Malay          | C++    | Select Country | india         | 1966 | April | 30  | Tania1234* | Tania1234* | C:\Users\user\Documents\GITDEMO - Register\GITDEMO\Automatizacion - demo\src\test\resources\Imagen\ImagenPrueba.PNG | Select Country\n |
      | Dino      | Perez    | Av Dosque | dino1@hotmail.com  | 3103900121 | Male   | Hockey-Movies  | Persian        | Linux  | Select Country | Denmark       | 1966 | April | 21  | Tania1234* | Tania1234* | C:\Users\user\Documents\GITDEMO - Register\GITDEMO\Automatizacion - demo\src\test\resources\Imagen\ImagenPrueba.PNG | Select Country\n |
