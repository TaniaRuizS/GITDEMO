# Autor: Tania Ruiz Sanchez
  ...
  Feature: pageDemo
    ...
    Scenario Outline: Enter data to register
      ...
      Examples:
        | firstname | lastname | address  | email              | phone      | year | month | day | password1  | password2  |
        | Tania     | Ruiz     | Av Japon | tania@hotmail.com  | 3103900118 | 1995 | April | 10  | Tania123*  | Tania123*  |
        | Patricia  | Sanchez  | Av cuba  | tania1@hotmail.com | 3103900120 | 1966 | April | 30  | Tania1234* | Tania1234* |
